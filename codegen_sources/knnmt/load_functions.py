...
def load_parallel_functions(dataset_path: str, language_pair: str = None):
    ...
    if language_pair is None or language_pair == "python_python":
        java_python_java_ori = open(f"{dataset_path}/train_ori_java.sa.tok", "r")
        java_ori_functions = java_python_java_ori.readlines()

        java_python_java_ec = open(f"{dataset_path}/train_ec_java.sa.tok", "r")
        java_ec_functions = java_python_java_ec.readlines()

        parallel_functions["python_python"] = list(zip(java_ec_functions, java_ori_functions))
...
def load_validation_functions(validation_set_path: str, language_pair: str = None, half: Optional[int] = None):
    ...
    if language_pair is None or language_pair == "python_python":
        parallel_functions["python_python"] = list(zip(java_functions, java_functions))
