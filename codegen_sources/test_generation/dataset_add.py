...
def main(model_path,bpe_path,pre_data_path,bpe_model,output_path):
    dict=[]
    keywords=[]
    ec_keywords1=[]
    ec_keywords2=[]
    ...
    dataset_pre=build_dataset_pre(ori_language_path,target_language_path,output_path)

    #translate to java
    df=pd.read_csv(output_path.joinpath('translated_java_add.csv'))
...
def build_dataset_pre(ori_language_path,target_language_path,output_path):
    contents1 = []
    contents2 = []
    ...
    dataset_pre=df.to_csv(output_path.joinpath('translated_java_add.csv'), index=False)
    print("===================succeeded================")
...
if __name__ == "__main__":
    ...
    main(args.model_path,args.bpe_path,args.pre_data_path,bpe_model,args.output_path)
