...
def write_tok_files(output_folder, lang1_funcs, lang2_funcs, lang1, lang2):
    if not lang1 < lang2:
    ...
    output_files_all = {
        lang1: open(
            output_folder.joinpath(f"train.{lang1}_sa-{lang2}_sa.{lang1}_sa.tok"), "w"
        ),
        lang2: open(
            output_folder.joinpath(f"train.{lang1}_sa-{lang2}_sa.{lang2}_sa.tok"), "w"
        ),
    }
